...
export const GO_NO_GO = [
  {
    ...
    why: "Sales −10% уводит NPV в минус",
    icon: "Users",
    tone: "cyan" as const,
  },
  {
    ...
    threshold: "≥ 25%",
    horizon: "стабильно",
    why: "GM −1,5 п.п. уводит NPV в минус",
    icon: "Percent",
    tone: "green" as const,
  },
  {
    ...
    horizon: "контракт",
    why: "Защита EBITDA в плотных локациях",
    icon: "Building2",
    tone: "amber" as const,
  },
  {
  ...
  },
  {
    ...
    horizon: "Y1",
    why: "Зарплаты ритейла +24-42% г/г",
    icon: "Wallet",
    tone: "rose" as const,
  },
];
